...
const SalesInvoiceTable = ({ thead, tbody, actionhandler }) => {
    ...
    const goToDetails = (data)=>{
        ...
        // console.log(data)
        navigate('/sales-details', {state: { sales: data }})
    }
...
{/* { item?.menuId?.image?.data[0] || theImage  || 'images/product/single/04.webp'} */}
                            ...
                            <Td>
                                ...
                                <Box className="mc-table-profile">
                                    <Image src={  item?.menuId?.image ||  'images/food-icons.jpg'  } alt={ item?.alt } />
